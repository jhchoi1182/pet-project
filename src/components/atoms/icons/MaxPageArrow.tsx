...
interface MaxPageArrowParameter {
  isMin?: boolean;
  onClick: () => void;
}

export default function MaxPageArrow({ isMin = false, onClick }: MaxPageArrowParameter) {
  return (
    <button aria-label="맨 처음/맨 끝 페이지로 이동 버튼" onClick={onClick}>
